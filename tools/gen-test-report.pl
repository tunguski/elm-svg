...
<title>elm-svg \x{b7} test report</title>
<style>
...
<div class="wrap">
  <div class="head">
    ...
    <div><a class="back" href="index.html">&larr; back to the charts</a></div>
  </div>
  $sections
  <div class="foot">Generated from the elm-test JSON report \x{b7} the Scale maths is pure, so every check runs headlessly.</div>
</div>
</body>
</html>
HTML
